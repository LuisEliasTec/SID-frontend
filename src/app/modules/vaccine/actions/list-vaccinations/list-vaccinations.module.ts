...
import { ListVaccinationsComponent } from './list-vaccinations.component';

@NgModule({
  declarations: [ListVaccinationsComponent],
  exports: [ListVaccinationsComponent],
  imports: [
    MatTableModule,
    RestApiModule,
...
export class ListVaccinationsModule { }
